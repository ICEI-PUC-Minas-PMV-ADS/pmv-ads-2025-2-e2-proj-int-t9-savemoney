...
namespace savemoney.Migrations
{
    ...
    [Migration("20251204053145_AddUsuarioIdToConversor")]
    partial class AddUsuarioIdToConversor
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("savemoney.Models.Usuario", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DataCadastro = new DateTime(2025, 12, 4, 2, 31, 45, 63, DateTimeKind.Local).AddTicks(3983),
