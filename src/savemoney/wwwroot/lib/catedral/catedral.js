...
/**
 * Componente de Header dinâmico.
 * Exibe um header com título, botão de menu e slot para menu customizado.
 * @see {@link ./components/header.js}
 */
export { default as CatedralHeader } from './components/header.js';
